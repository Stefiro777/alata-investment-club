    ...
    <>
      <div className="flex items-start gap-4 px-6 py-4 border-b border-black/5 last:border-b-0 hover:bg-[#f9f9f9] transition-colors">
        ...
        <div className="flex-1 min-w-0">
          ...
          {venue.price_notes && (
            <p className="text-xs text-forest mt-1 font-medium">{venue.price_notes}</p>
          )}
...
export default function VenuesClient({ initialVenues }: { initialVenues: Venue[] }) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-10">
      <div className="mb-8">
        <h2 className="font-serif text-2xl font-bold text-ink-900">Venue Database</h2>
        <div className="w-10 h-0.5 bg-forest mt-2" />
        <p className="text-xs text-ink-500 mt-3">Lista interna di locali per eventi — visibile solo agli admin.</p>
      </div>
