    ...
    <>
      ...
      <main className="bg-[#f9f9f9] min-h-screen">
        <div className="max-w-5xl mx-auto px-8 py-10">
          <div className="mb-8">
            <h2 className="font-serif text-2xl font-bold text-[#0a0a0a]">Public Relations Tracker</h2>
            <div className="w-10 h-0.5 bg-[#1a4a3a] mt-2" />
          </div>

          <div className="bg-white border border-black/10 px-8 py-10 flex flex-col items-start gap-4 max-w-lg">
            <a
              href={TRACKER_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#1a4a3a] hover:bg-[#123a2d] text-white text-xs font-medium tracking-wide uppercase px-6 py-3 transition-colors"
            >
