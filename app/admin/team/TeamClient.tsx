  ...
  if (!open) {
    return (
      <button
        ...
        className="flex items-center gap-2 text-xs font-medium text-[#1a4a3a] border border-[#1a4a3a] px-4 py-2.5 hover:bg-[#1a4a3a] hover:text-white transition-colors duration-150"
      >
