    ...
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="mb-12">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-light text-[#0a0a0a]">Materials</h2>
          <div className="w-10 h-px bg-[#1B3A4B] mt-4" />
        </div>
              ...
              <div key={mat.id} className="bg-white p-6 flex flex-col gap-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="w-9 h-9 bg-[#f5f5f5] flex items-center justify-center flex-shrink-0">
                    <svg className="w-4 h-4 text-[#1B3A4B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-[#1B3A4B] hover:text-[#0a0a0a] text-xs font-medium tracking-wide uppercase transition-colors border-t border-[#f5f5f5] pt-4 mt-1"
                >
