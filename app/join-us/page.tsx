  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[500px] lg:min-h-[610px] text-white flex items-center overflow-hidden">
        <Parallax>
          <Image src="/piazzavittoria.jpg" alt="" fill className="object-cover grayscale animate-ken-burns" style={{ objectPosition: 'center 60%' }} preload />
        </Parallax>
        ...
        <div className="relative z-10 w-full py-20 sm:py-28">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <MotionReveal delay={0} y={20}>
              <p className="text-xs tracking-[0.2em] uppercase text-white/50 mb-4">Join Us</p>
            </MotionReveal>
      ...
      <section id="application-form" className="bg-forest py-24 sm:py-32 px-6 relative overflow-hidden">
        <span
          className="absolute -bottom-12 -right-2 font-serif italic font-semibold text-[10rem] sm:text-[13rem] leading-none text-white/[0.045] select-none pointer-events-none"
          aria-hidden="true"
        >
          Alata
        </span>
