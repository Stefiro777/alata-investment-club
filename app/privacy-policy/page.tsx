  ...
  return (
    <div className="bg-white min-h-screen py-16 px-6">
      <div className="max-w-3xl mx-auto">
        <p className="text-xs tracking-[0.2em] uppercase text-ink-500 mb-4">Legal</p>
        <h1 className="font-serif text-4xl sm:text-5xl font-bold text-forest leading-tight mb-4">
          Privacy Policy
        </h1>
        <div className="w-10 h-0.5 bg-forest mb-6" />
        <p className="text-sm text-ink-500 mb-12">Last updated: April 2026</p>

        <div className="space-y-10 text-sm text-[#4b5563] leading-relaxed">

          <section>
            <h2 className="font-serif text-xl font-bold text-ink-900 mb-3">1. Data Controller</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl font-bold text-ink-900 mb-3">2. Data We Collect</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-bold text-ink-900 mb-3">3. Purpose of Processing</h2>
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <div>
                <p className="font-semibold text-ink-900">Microsoft Clarity</p>
              ...
              <div>
                <p className="font-semibold text-ink-900">Resend</p>
          ...
          <section>
            <h2 className="font-serif text-xl font-bold text-ink-900 mb-3">5. Data Retention</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-bold text-ink-900 mb-3">6. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl font-bold text-ink-900 mb-3">7. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl font-bold text-ink-900 mb-3">8. Contact</h2>
            <p>
