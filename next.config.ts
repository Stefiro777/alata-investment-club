...
const CSP = [
  "default-src 'self'",
  // Next.js inline scripts + Vercel + unpkg (PDF.js worker)
  // 'unsafe-eval' is added only in development for HMR / fast-refresh
  `script-src 'self' 'unsafe-inline'${isDev ? " 'unsafe-eval'" : ''} https://va.vercel-scripts.com https://vercel.live https://unpkg.com https://js.stripe.com https://www.googletagmanager.com https://www.google-analytics.com`,
  ...
  "frame-src 'self' blob: https://iyigyfygsalvvveeeheq.supabase.co https://www.youtube.com https://player.vimeo.com https://js.stripe.com https://hooks.stripe.com",
